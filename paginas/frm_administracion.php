  ...
  <body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col col-8">
                    <h1 class="text-center">Formulario Administracion</h1>
                    <form action="../objetos/objeto_administracion.php" method="get">
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="txtBonificacion" name="txtBonificacion" placeholder="ingreses Comision Ventas">
                          </div>
