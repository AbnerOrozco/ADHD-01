  ...
  <body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col col-8">
                    <h1 class="text-center">Formulario Ventas</h1>
                    <form action="../objetos/objeto_ventas.php" method="get">
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="txtTipoContratacion" name="txtTipoContratacion" placeholder="ingreses Tipo Contratacion">
                          </div>
                          <div class="mb-3">
                            <label for="txtComisionVentas" class="form-label">Comision ventas</label>
                            <input type="number" class="form-control" id="Nit" name="txtComisionVentas" placeholder="ingreses Comision Ventas">
                          </div>
